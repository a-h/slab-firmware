...
#define NUM_PIXELS 29 // 20 keys + 9 LEDs in a bar along the side.
...
uint32_t lookup_expanders[30] = {
    ...
    0b00000000000000000000000100000000, // 3
    0b00000000000000000000001000000000, // 4
    0b00000000000000000000000010000000, // 5
    0b00000000000000000000000001000000, // 6
    0b00000000000000000000010000000000, // 7
    0b00000000000000000000100000000000, // 8
    0b00000000000000000000000000001000, // 9
    0b00000000000000000000000000000100, // 10
    0b00000000000000000010000000000000, // 11
    0b00000000000000000001000000000000, // 12
    0b00000000100000000000000000000000, // 13
    0b00000000010000000000000000000000, // 14
    0b00000001000000000000000000000000, // 15
    0b00000010000000000000000000000000, // 16
    0b00000000001000000000000000000000, // 17
    0b00000000000100000000000000000000, // 18
    0b00001000000000000000000000000000, // 19
    0b00000100000000000000000000000000, // 20
};
